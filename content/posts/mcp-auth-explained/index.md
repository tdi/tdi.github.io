...
This stopped being theoretical in June 2026: MCP shipped **[Enterprise-Managed Authorization](https://blog.modelcontextprotocol.io/posts/enterprise-managed-auth/)** as a stable extension, an MCP-specific profile of exactly this flow — "authorize once, inherit everywhere," with Okta first out of the gate on the IdP side and Anthropic and VS Code among the launch adopters. (Notably it ships as a versioned *extension*, the new way MCP evolves auth without cutting a whole spec revision.)
